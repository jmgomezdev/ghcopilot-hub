...
- In Next.js 15, `GET` handlers are not cached by default
...
In Next.js 15 repositories, middleware can still be part of auth or redirect flows, but it is not sufficient as the only
security boundary.
