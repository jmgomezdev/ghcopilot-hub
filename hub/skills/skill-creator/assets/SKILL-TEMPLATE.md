...
name: { skill-name }
description: >
  {Brief description of what this skill enables}. Trigger: {When the AI should load this skill - be specific}.
license: Apache-2.0
metadata:
  author: jmgomezdev
  version: "1.0"
...
{comma-separated list of relevant keywords for this skill}
